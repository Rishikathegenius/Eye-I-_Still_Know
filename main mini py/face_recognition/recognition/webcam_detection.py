...
from recognition import object_detection
...
# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = "D:\main mini py\\face_recognition\\recognition\object_detection\data\mscoco_label_map.pbtxt"
...
class ObjectDetect(object):
    ...
    def get_frame(self):
        ...
        # dimensions
        image_np = imutils.resize(frame, width=800)
        (h, w) = frame.shape[:2]
